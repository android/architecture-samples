...
@RunWith(AndroidJUnit4::class) @LargeTest class TasksScreenTest {
    ...
    private val toolbarNavigationContentDescription: String
        get() = tasksActivityTestRule.activity.getToolbarNavigationContentDescription(
            com.example.android.architecture.blueprints.todoapp.R.id.toolbar)
    ...
    @Test fun clickAddTaskButton_opensAddTaskUi() {
        ...
        onView(withId(com.example.android.architecture.blueprints.todoapp.R.id.fab_add_task)).perform(click())

        // Check if the add task screen is displayed
        onView(withId(com.example.android.architecture.blueprints.todoapp.R.id.add_task_title)).check(matches(isDisplayed()))
    }
    ...
    @Test fun editTask() {
        ...
        onView(withId(com.example.android.architecture.blueprints.todoapp.R.id.fab_edit_task)).perform(click())

        val editTaskTitle = TITLE2
        val editTaskDescription = "New Description"

        // Edit task title and description
        onView(withId(com.example.android.architecture.blueprints.todoapp.R.id.add_task_title))
                .perform(replaceText(editTaskTitle), closeSoftKeyboard()) // Type new task title
        onView(withId(com.example.android.architecture.blueprints.todoapp.R.id.add_task_description)).perform(replaceText(editTaskDescription),
                closeSoftKeyboard()) // Type new task description and close the keyboard

        // Save the task
        onView(withId(com.example.android.architecture.blueprints.todoapp.R.id.fab_edit_task_done)).perform(click())
    ...
    @Test fun clearCompletedTasks() {
        ...
        onView(withText(com.example.android.architecture.blueprints.todoapp.R.string.menu_clear)).perform(click())
    ...
    @Test fun createOneTask_deleteTask() {
        ...
        onView(withId(com.example.android.architecture.blueprints.todoapp.R.id.menu_delete)).perform(click())
    ...
    @Test fun markTaskAsCompleteOnDetailScreen_taskIsCompleteInList() {
        ...
        onView(withId(com.example.android.architecture.blueprints.todoapp.R.id.task_detail_complete)).perform(click())

        // Click on the navigation up button to go back to the list
        onView(withContentDescription(toolbarNavigationContentDescription)).perform(click())

        // Check that the task is marked as completed
        onView(allOf(withId(com.example.android.architecture.blueprints.todoapp.R.id.complete),
    ...
    @Test fun orientationChange_FilterCompletedPersists() {
        ...
        // then nothing changes
        onView(withText(TITLE1)).check(matches(isDisplayed()))
        onView(withText(com.example.android.architecture.blueprints.todoapp.R.string.label_completed)).check(matches(isDisplayed()))
    }
    ...
    @Test @SdkSuppress(minSdkVersion = 21) fun orientationChange_DuringEdit_ChangePersists() {
        ...
        onView(withId(com.example.android.architecture.blueprints.todoapp.R.id.add_task_title)).check(matches(withText(TITLE2)))
    }
    ...
    @Test @SdkSuppress(minSdkVersion = 21) fun orientationChange_DuringEdit_NoDuplicate() {
        ...
        onView(withId(com.example.android.architecture.blueprints.todoapp.R.id.add_task_title))
                .perform(replaceText(TITLE2), closeSoftKeyboard()) // Type new task title
        onView(withId(com.example.android.architecture.blueprints.todoapp.R.id.add_task_description)).perform(replaceText(DESCRIPTION),
                closeSoftKeyboard()) // Type new task description and close the keyboard
    ...
    @Test fun noTasks_AllTasksFilter_AddTaskViewVisible() {
        ...
        onView(withId(com.example.android.architecture.blueprints.todoapp.R.id.noTasksAdd)).check(matches(isDisplayed()))
    }
    ...
    @Test fun noTasks_CompletedTasksFilter_AddTaskViewNotVisible() {
        ...
        // Add task View should be displayed
        onView(withId(com.example.android.architecture.blueprints.todoapp.R.id.noTasksAdd)).check(matches(not(isDisplayed())))
    }
    ...
    private fun viewAllTasks() {
        onView(withId(com.example.android.architecture.blueprints.todoapp.R.id.menu_filter)).perform(click())
        onView(withText(com.example.android.architecture.blueprints.todoapp.R.string.nav_all)).perform(click())
    }

    private fun viewActiveTasks() {
        onView(withId(com.example.android.architecture.blueprints.todoapp.R.id.menu_filter)).perform(click())
        onView(withText(com.example.android.architecture.blueprints.todoapp.R.string.nav_active)).perform(click())
    }

    private fun viewCompletedTasks() {
        onView(withId(com.example.android.architecture.blueprints.todoapp.R.id.menu_filter)).perform(click())
        onView(withText(com.example.android.architecture.blueprints.todoapp.R.string.nav_completed)).perform(click())
    }
    ...
    private fun createTask(title: String, description: String) {
        ...
        onView(withId(com.example.android.architecture.blueprints.todoapp.R.id.add_task_title)).perform(typeText(title),
                closeSoftKeyboard()) // Type new task title
        onView(withId(com.example.android.architecture.blueprints.todoapp.R.id.add_task_description)).perform(typeText(description),
                closeSoftKeyboard()) // Type new task description and close the keyboard
    ...
    private fun clickCheckBoxForTask(title: String) {
        onView(allOf(withId(com.example.android.architecture.blueprints.todoapp.R.id.complete), hasSibling(withText(title)))).perform(click())
    }
