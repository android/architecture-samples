...
| [dev‑todo‑mvp‑room](https://github.com/googlesamples/android-architecture/tree/dev-todo-mvp-room/) | Uses Room, the persistance library from the [Architecture Components](http://developer.android.com/arch), as a local data source with an MVP architecture. |
